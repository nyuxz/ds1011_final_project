        ...
        for batch in train_iter:
            ...
            if step % 100 == 0:
                ...
                if dev_acc > best_dev_acc:
                    ...
                    torch.save(input_encoder.state_dict, 'input_encoder_try_3.pt')
                    torch.save(model.state_dict(), 'decomp_atten_try_3.pt')
...
def main():
    ...
    train_iter, dev_iter, test_iter = data.BucketIterator.splits((train, dev, test), batch_size=16, device=None)
