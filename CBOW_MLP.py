...
parser.add_argument('--num_labels', default=3, type=int,
                    help='number of labels (default: 3)')
...
def main():
	...
	global args, num_train_steps, learning_rate, batch_size, embedding_dim
	...
	model = MLPClassifier(input_size, embedding_dim, args.hidden_dim, args.num_labels)   
	# Loss and Optimizer
